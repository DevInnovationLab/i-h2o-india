...
- which villages have this SVS scheme?
...
odishasum_SVSsubs <- odishasum |> dplyr::select(dist_name, num_hh_SVS, num_vil_SVS, avg_preg_per_vil, U2MR_23)
...
- based on this I recommended 1 to 3k villages needed for randomization
