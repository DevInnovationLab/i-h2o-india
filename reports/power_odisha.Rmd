...
odishasum_SVSsubs$avg_u5_per_vil <- odishasum_SVSsubs$avg_preg_per_vil * 5
odishasum_SVSsubs$diarrhea_incidence <- .05 # can expand to have district wise variation later
...
Hi All, here are the powercalculations on diarrhea I was asked to do. I am out of office and in transit but try to be responsive on slack if there are any questions. The R code is lying 
