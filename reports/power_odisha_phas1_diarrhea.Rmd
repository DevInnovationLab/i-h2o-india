...
to be added - computationally costly due to the AR1 process. Need to find a way to make code more efficient. As noted above, the autocorrelation is not too high and won't affect power numbers much.
