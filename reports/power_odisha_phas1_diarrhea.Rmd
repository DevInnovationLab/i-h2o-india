...
Autocorrelation of diarrhea incidence within individuals over time is considered here as well (in the form of an AR(1) process), but seems to be less of a concern for power.
...
# 1) Descriptives - diarrhea counts
...
```{r, eval = T, include = T, fig.width = 4, fig.height = 3, fig.cap = "Diarrhea counts per cluster - approximately Poisson."}
...
# 2) Benchmark calculations (plug-in formulas)
