...
The spreadsheet contains (extracted from this notebook) a replication of the synthetic cohort U2 mortality estimates that the India team produced and U2 mortality estimates that I produced with a true cohort approach directly from the NFHS dataset(s).
...
The "true_cohort_method" sheet visualizes the shrunk estimates for the true cohort method U2 at the district level and shows the projected time trend (a 3.3 percent decrease based on the state-level trend for the last 10 years)
...
nfhs.sub.3y$U2MRwt.block6[nfhs.sub.3y$block6 == 1] <- weighted.mean(nfhs.sub.3y$U2MRwt[nfhs.sub.3y$block6 == 1],
                                                                    nfhs.sub.3y$nobswt[nfhs.sub.3y$block6 == 1])
