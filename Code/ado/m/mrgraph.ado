*! version 1.04, Ben Jann, 28jul2004
...
//Syntax parsing
	...
	syntax varlist [if] [in] [fweight aweight] [ , /*
	 ...
	 mrtab_options   */ Response(passthru) Poly INclude INCLUDEMissing CASEwise COUNTall /*
	                 */ sort SORT2(numlist int max=1 >0) DEScending by(string) /*
...
//Retrieve frequencies
	mrtab `varlist' `if' `in' [`weight'`exp'] , `response' `poly' /*
