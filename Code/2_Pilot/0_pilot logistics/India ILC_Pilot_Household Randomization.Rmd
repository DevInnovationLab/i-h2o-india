...
ilc <- ilc%>%
  select("unique_ID", "A1_resp_name", "A6_phone_num", "A8_address", "A9_landmark", "district_name", "block_name", "gp_name", "village_name", "hamlet_name", "A3_malehead_name", "A7_phone_oth", "A4_oldmale_name", "A9_GPS", "starttime"
         )%>%
...
#Jeremy's
sheet_path <- "C:/Users/jerem/Box/India Water project/2_Pilot/Data/1_raw/0_field logistics/2_randomization list/India ILC_Pilot_Household Tracking_randomized.csv"
...
write_csv(hh_randomization, file = sheet_path,
          append = TRUE
...
write_csv(hh_randomization, append = TRUE, file = sheet_path
          #, col_names = TRUE #Needed for initializing the dataset so there are column names
          )
