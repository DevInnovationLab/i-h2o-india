...
ilc_glm <- function(data, var){
  ...
  #for(i in var){
    ...
    colnames(tidy_results) <- c("covariate", "estimate", "std.error", "z_statistic", "p_value")
    
    #Appending to overall model list
    #model_list <- append(model_list, tidy_results)
