...
#map data - shapefile
shp_file <- st_read(paste0(user_path(), "7_map/shapefiles/gadm41_IND_0.shp"))
...
map_p1 <- ggplot() +
  geom_sf(data = shp_file, fill = "white", color = "black") +  # Base map for Odisha
  #geom_sf(data = rayagad, fill = "red", color = "black") +  # Highlight Rayagada
  theme_minimal() +
  ggtitle("Rayagada District in Odisha, India") +
  theme(
