...
mon_long <- read_csv(paste0(user_path(),"/3_final/logitudinal_testing_cleaned.csv"))
...
#Cen final
cen_info <- read_stata(paste0(user_path(),"4_other/Final_Population_Village.dta" ))


#endline census
#el <- read_stata(paste0(user_path(),"3_final/1_8_Endline_Census_cleaned.dta" ))
el <- read_stata(paste0(user_path(),"/3_final/1_10_Endline_Census_HH_clean_consented.dta")) #NB: replacing with final version of EL data
...
p_ec_pooled <- ggplot(data = tc_stats_pooled) + 
  ...
  labs(x = "Sample Type", 
       y = expression(paste("% positive for ",italic("E. coli"))),
       fill = "Assignment",
       title = expression(paste("Presence of ", italic("E. coli"), " in Household Drinking Water (N = 960)")),
