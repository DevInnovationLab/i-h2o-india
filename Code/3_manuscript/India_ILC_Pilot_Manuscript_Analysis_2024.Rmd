...
bl <- bl%>%
  dplyr::select(unique_id, village, village_ID, block, `Block code`, panchayat_village, assignment,
                water_source_prim, water_sec_yn, treat_water_before, treat_time_category, collect_resp, treat_resp,
                collect_resp_women, collect_resp_both, collect_resp_men, treat_resp_women, treat_resp_men, treat_resp_both,
                treat_time_5min, sample_ID_tap, sample_ID_stored, tap_taste_binary,
...
# #All rounds survey data
# all_rounds <- all_rounds%>%
#   dplyr::select(c("unique_id", "village", "block", "panchayat_village", "data_round", "pooled_round",
#                   "assignment", "fc_tap_binary", "fc_stored_binary",
...
#mon_summary_weekly no changes needed
  ...
  write_csv(idexx_abr, paste0(user_path(), "3_final/manuscript_datasets/", "1_10_idexx_abr.csv"))
  write_csv(all_rounds, paste0(user_path(), "3_final/manuscript_datasets/", "1_8_surveys_all_rounds.csv"))
