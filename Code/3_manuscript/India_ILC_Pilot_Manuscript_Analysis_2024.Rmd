...
idexx_tab <- idexx%>%
  dplyr::select(assignment, unique_id, village, block, panchayat_village, sample_ID, bag_ID_tap, bag_ID_stored, cf_pa_binary, sample_type, ec_pa_binary, cf_log, ec_log)%>%
  mutate(data_round = "BL")%>%
