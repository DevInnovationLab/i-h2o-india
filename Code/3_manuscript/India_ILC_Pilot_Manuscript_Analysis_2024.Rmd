...
p_ec_cl_3 <- idexx_cl_comb%>%
  ...
  scale_x_date(limits = c(ymd("2023-10-06"), ymd("2024-10-08")),
        date_breaks = "1 month",   # Adds more frequent x-axis breaks (monthly)
        date_labels = "%b")+
  scale_fill_brewer(palette = "Pastel1")+
  labs(x = "Date", 
...
p_ec_cl_4 <- idexx_cl_comb%>%
  ...
  #geom_path(aes(x = test_week, y = cl_presence), color = "#FF474C")+ #Geom path makes the plot cluttered
  geom_vline(aes(xintercept = ymd("2024-02-01")), lty = 2, color = "#FF474C")+ #Placing intervention start date
  geom_vline(aes(xintercept = ymd("2024-09-01")), lty = 2, color = "green")+ #Placing protocol change date
  # geom_text(aes(x = ymd("2024-02-01"), y = 80, label = "Intervention Start"),
  #           nudge_x = -25, color = "#FF474C")+
  scale_y_continuous(
                     limits = c(0, 105),
  ...
  scale_x_date(limits = c(ymd("2024-1-06"), ymd("2024-10-08")),
        date_breaks = "1 month",   # Adds more frequent x-axis breaks (monthly)
        date_labels = "%b")+
  scale_fill_brewer(palette = "Pastel1")+
  labs(x = "Date", 
...
ggsave(filename = "manuscript_e_coli_chlorine_time_series_v4.jpeg", path = (paste0(github_path(), "/3_manuscript/figures")), dpi = 1080, width = 6, height = 3, units = "in", scale = 2)
...
p_ec_cl_6 <- idexx_cl_comb_2%>%
  ...
  geom_text(aes(x = ymd("2024-08-20"), y = 77, label = "Dose"), size = 3,
            nudge_x = -8, color = "darkgreen")+
  geom_text(aes(x = ymd("2024-08-20"), y = 74, label = "Increase"), size = 3,
            nudge_x = -8, color = "darkgreen")+
