...
# mon_summary_percent <- mon_summary%>%
#   group_by() %>%
#   summarise(
#     "Number of Samples" = n(),
#     "Tap - % Positive for Free Chlorine" = round((sum(cl_pa == "1") / n()) * 100,
#                                                  1),
#     "Stored - % Positive for Free Chlorine" = round((sum(cl_pa == "1") / n()) * 100, 1)
# )

#Monitoring data for all villages -------------------------------------------
