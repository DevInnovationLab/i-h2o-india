...
packages <- c("rsurveycto", "expss", "labelled", "httr", "lubridate", "quantitray",
              ...
              "tidyverse", "sf", "gridExtra", "crosstable", "viridis")
...
ggsave(filename = "manuscript_e_coli_chlorine_time_series_v5.jpeg", path = (paste0(github_path(), "/3_manuscript/figures")), dpi = 1080, width = 6, height = 4.5, units = "in", scale = 2)
...
p_forestplot <- ggplot(el_models_forestplot, aes(x = mean, y = model_name)) +
  ...
  scale_color_manual(values = c("Water Quality Outcome" = "#00008B", "Behavioral Outcome" = "#EEA944")) +  # Custom colors
  
  #scale_color_manual(values = family_colors) +  # Uses customized colors for 'intervention'
  labs(
    x = "Prevalence Ratio", 
    y = "Outcome") + 
  theme_classic() +
...
ggsave(filename = "forestplot_v2.png", path = (paste0(github_path(), "/3_manuscript/figures")), dpi = 1080, width = 11, height = 6, units = "in")
