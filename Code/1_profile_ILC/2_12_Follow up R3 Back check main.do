...
do "${Do_lab}import_india_ilc_pilot_backcheck_follow_up_R3_Master.do"
...
forvalues i = 1/20 {
replace Main_Respondent_str = r_fu3_r_cen_fam_name`i' if main_respondent == `i'
}

*follow up resp
gen followup_resp = ""
forvalues i = 1/20 {
replace followup_resp = r_fu3_r_cen_fam_name`i' if  who_interviwed_before_`i' == 1
}
...
merge 1:1 unique_id using "$In_progress_files/BC_FollowpR3_for_merging_with_followup.dta"
...
save "$In_progress_files/Follow_upR3_data_for_matching.dta", replace
