* import_india_ilc_pilot_hh_followup_R3_survey_enc.do
*
* 	Imports and aggregates "HH follow up R3 survey" (ID: india_ilc_pilot_hh_followup_R3_survey_enc) data.
*
*	Inputs:  "HH follow up R3 survey_WIDE.csv"
*	Outputs: "/Users/asthavohra/Documents/GitHub/i-h2o-india/Code/1_profile_ILC/Label/HH follow up R3 survey.dta"
*
*	Output by SurveyCTO April 7, 2024 12:27 PM.
...
local text_fields7 "cen_fam_gender17 cen_fam_gender18 cen_fam_gender19 cen_fam_gender20 info_update reason_replacement_oth replacement_id_3_digit replacement_id enum_name_label duration_locatehh audio_audit"
local text_fields8 "reasons_no_consent no_consent_oth duration_consent water_prim_oth primary_water_label water_source_sec water_source_sec_oth secondary_water_label num_water_sec water_sec_list_count water_sec_index_*"
local text_fields9 "water_sec_value_* water_sec_label_* water_sec_labels water_sec1 water_sec2 water_sec3 water_sec4 water_sec5 water_sec6 water_sec7 water_sec8 water_sec9 water_sec10 secondary_main_water_label"
local text_fields10 "collect_resp people_prim_water num_people_prim people_prim_list_count people_prim_index_* people_prim_value_* people_prim_label_* people_prim_labels people_prim1 people_prim2 people_prim3 people_prim4"
local text_fields11 "people_prim5 people_prim6 people_prim7 people_prim8 people_prim9 people_prim10 people_prim11 people_prim12 people_prim13 people_prim14 people_prim15 people_prim16 people_prim17 people_prim18"
local text_fields12 "people_prim19 people_prim20 liter_estimation_count container_nmbr_* source_container_* source_container_oth_* water_treat_when water_treat_when_oth water_treat_type water_treat_type_oth treat_resp"
local text_fields13 "num_treat_resp treat_resp_list_count treat_resp_index_* treat_resp_value_* treat_resp_label_* treat_resp_labels treat_resp1 treat_resp2 treat_resp3 treat_resp4 treat_resp5 treat_resp6 treat_resp7"
local text_fields14 "treat_resp8 treat_resp9 treat_resp10 treat_resp11 treat_resp12 treat_resp13 treat_resp14 treat_resp15 treat_resp16 treat_resp17 treat_resp18 treat_resp19 treat_resp20 duration_seca tap_supply_freq_oth"
local text_fields15 "tap_function_noreason tap_function_reason_oth tap_use tap_use_oth cooking_issue_reason skin_treat_type tap_use_drinking_oth tap_function_reason tap_function_oth tap_use_future_oth duration_secb"
local text_fields16 "tap_taste_desc tap_taste_desc_oth tap_smell tap_smell_oth tap_color tap_color_oth tap_trust_fu tap_trust_oth duration_secc no_test_reason unique_id_3_digit_wt no_stored_bag stored_bag_source_oth"
local text_fields17 "tap_barcode_stored no_chlorine_stored no_running_bag tap_barcode_running no_tap_reason error_types_count calc_error_nmbr_* testing_comment duration_sece time_stored_running overall_comment"
local text_fields18 "duration_end survey_member_names_count surveynumber_* instanceid instancename"
local date_fields1 ""
...
if _N>0 {
	...
	* label variables
	...
	label variable water_treat_type "W19) What did your household do to the water to make it safe for drinking? (This"
	note water_treat_type: "W19) What did your household do to the water to make it safe for drinking? (This is for both primary and secondary source)"
	...
	label variable general_issue "G7) In the last one month, has your household faced any issues in using governem"
	note general_issue: "G7) In the last one month, has your household faced any issues in using governement provided tap water/ supply paani ?"
	label define general_issue 1 "Yes" 0 "No"
	label values general_issue general_issue

	label variable types_of_issues "G8) What are the issues you faced?"
	note types_of_issues: "G8) What are the issues you faced?"
	label define types_of_issues 1 "Cooking related issues" 2 "Skin related issues" 3 "Both Cooking and skin related issues"
	label values types_of_issues types_of_issues

	label variable cooking_issue_reason "What are the issues you faced while cooking?"
	note cooking_issue_reason: "What are the issues you faced while cooking?"

	label variable skin_treat "Did you do anything to treat this skin condition?"
	note skin_treat: "Did you do anything to treat this skin condition?"
	...
	label define skin_issues_before 1 "Yes" 0 "No"
	label values skin_issues_before skin_issues_before
	...
	label variable tap_use_drinking_oth "G9.1) Please specify other"
	note tap_use_drinking_oth: "G9.1) Please specify other"
...
*
*   Corrections file path and filename:  HH follow up R3 survey_corrections.csv
*
