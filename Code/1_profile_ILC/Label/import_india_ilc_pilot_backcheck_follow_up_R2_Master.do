* import_india_ilc_pilot_backcheck_follow_up_R2_Master.do
*
* 	Imports and aggregates "R2_FollowUp_BackCheck_Form" (ID: india_ilc_pilot_backcheck_follow_up_R2_Master) data.
*
*	Inputs:  "C:/Users/Archi Gupta/Box/Data/1_raw/R2_FollowUp_BackCheck_Form_WIDE.csv"
*	Outputs: "C:/Users/Archi Gupta/Box/Data/1_raw/R2_FollowUp_BackCheck_Form.dta"
*
*	Output by SurveyCTO March 11, 2024 7:40 PM.
...
local csvfile "C:/Users/Archi Gupta/Box/Data/1_raw/R2_FollowUp_BackCheck_Form_WIDE.csv"
local dtafile "C:/Users/Archi Gupta/Box/Data/1_raw/R2_FollowUp_BackCheck_Form.dta"
local corrfile "C:/Users/Archi Gupta/Box/Data/1_raw/R2_FollowUp_BackCheck_Form_corrections.csv"
local note_fields1 ""
local text_fields1 "deviceid subscriberid simid devicephonenum unique_id_3_digit unique_id r_fu2_r_cen_landmark r_fu2_r_cen_address r_fu2_r_cen_saahi_name r_fu2_main_respondent r_fu2_r_cen_a10_hhhead"
local text_fields2 "r_fu2_r_cen_a39_phone_name_1 r_fu2_r_cen_a39_phone_num_1 r_fu2_r_cen_a39_phone_name_2 r_fu2_r_cen_a39_phone_num_2 r_fu2_r_cen_village_name_str r_fu2_r_cen_hamlet_name r_fu2_r_cen_a11_oldmale_name"
local text_fields3 "r_fu2_r_cen_fam_name1 r_fu2_r_cen_fam_name2 r_fu2_r_cen_fam_name3 r_fu2_r_cen_fam_name4 r_fu2_r_cen_fam_name5 r_fu2_r_cen_fam_name6 r_fu2_r_cen_fam_name7 r_fu2_r_cen_fam_name8 r_fu2_r_cen_fam_name9"
local text_fields4 "r_fu2_r_cen_fam_name10 r_fu2_r_cen_fam_name11 r_fu2_r_cen_fam_name12 r_fu2_r_cen_fam_name13 r_fu2_r_cen_fam_name14 r_fu2_r_cen_fam_name15 r_fu2_r_cen_fam_name16 r_fu2_r_cen_fam_name17"
local text_fields5 "r_fu2_r_cen_fam_name18 r_fu2_r_cen_fam_name19 r_fu2_r_cen_fam_name20 r_fu2_water_source_prim info_update enum_name_label who_interviwed_before missing_household_member_name no_consent_reason"
...
if _N>0 {
	...
	* label variables
	...
	note noteconf1: "Please confirm the households that you are visiting correspond to the following information. Village: \${R_FU2_r_cen_village_name_str} Hamlet: \${R_FU2_r_cen_hamlet_name} Household head name: \${R_FU2_r_cen_a10_hhhead} Respondent name from the previous round: \${R_FU2_Main_Respondent} Any male household head (if any): \${R_FU2_r_cen_a11_oldmale_name} Address: \${R_FU2_r_cen_address} Landmark: \${R_FU2_r_cen_landmark} Saahi: \${R_FU2_r_cen_saahi_name} Phone 1: \${R_FU2_r_cen_a39_phone_name_1} (\${R_FU2_r_cen_a39_phone_num_1}) Phone 2: \${R_FU2_r_cen_a39_phone_name_2} (\${R_FU2_r_cen_a39_phone_num_2})"
	...
	label define enum_name 122 "Hemant Bagh" 101 "Sanjay Naik" 103 "Rajib Panda" 105 "Bibhar Pankaj" 110 "Sarita Bhatra" 119 "Pramodini Gahir" 121 "Ishadatta Pani" 123 "Manas Ranjan" 124 "Prasantha Panda"
	...
	label define main_respondent 1 "\${R_FU2_r_cen_fam_name1}" 2 "\${R_FU2_r_cen_fam_name2}" 3 "\${R_FU2_r_cen_fam_name3}" 4 "\${R_FU2_r_cen_fam_name4}" 5 "\${R_FU2_r_cen_fam_name5}" 6 "\${R_FU2_r_cen_fam_name6}" 7 "\${R_FU2_r_cen_fam_name7}" 8 "\${R_FU2_r_cen_fam_name8}" 9 "\${R_FU2_r_cen_fam_name9}" 10 "\${R_FU2_r_cen_fam_name10}" 11 "\${R_FU2_r_cen_fam_name11}" 12 "\${R_FU2_r_cen_fam_name12}" 13 "\${R_FU2_r_cen_fam_name13}" 14 "\${R_FU2_r_cen_fam_name14}" 15 "\${R_FU2_r_cen_fam_name15}" 16 "\${R_FU2_r_cen_fam_name16}" 17 "\${R_FU2_r_cen_fam_name17}" 18 "\${R_FU2_r_cen_fam_name18}" 19 "\${R_FU2_r_cen_fam_name19}" 20 "\${R_FU2_r_cen_fam_name20}" -77 "Other"
...
*
*   Corrections file path and filename:  C:/Users/Archi Gupta/Box/Data/1_raw/R2_FollowUp_BackCheck_Form_corrections.csv
*
