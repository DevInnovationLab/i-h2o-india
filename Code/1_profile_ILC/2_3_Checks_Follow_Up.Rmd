...
star.out <- sub("cccccccc", "{l p{2cm} *{8}{p{1cm}}}")
  ...
  mutate(Var1 = ifelse(Var1 == "R_FU_tap_taste_satisfied", "How satisfied are you with the taste of water from government taps?", 
                       ifelse(Var1 == "R_FU_tap_taste_desc",
                              "Describe the taste of water from government taps", 
                                     ifelse(Var1 == "R_FU_tap_smell_desc", 
                                            "Describe the smell of water from government taps",
                                            ifelse(Var1 == "R_FU_tap_color_desc",
...
stargazer(df.append, summary=F, title= "Chlorine Perceptions Section Summary",float=F,rownames = F,
           covariate.labels=NULL)
...
stargazer(df.exp, summary=F, title= "Chlorine Experience Summary",float=F,rownames = F,
           covariate.labels=NULL)
