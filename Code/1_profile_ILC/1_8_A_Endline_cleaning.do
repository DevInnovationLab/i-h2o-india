...
save "${DataFinal}1_8_Endline/1_8_Endline_Census_cleaned.dta", replace
savesome using "${DataFinal}1_8_Endline/1_8_Endline_Census_cleaned_consented.dta" if R_E_consent==1, replace
