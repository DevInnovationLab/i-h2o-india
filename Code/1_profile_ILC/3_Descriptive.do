...
gen     Census=1
keep unique_id R_Cen_consent R_Cen_screen_u5child R_Cen_screen_preg Census village
...
keep Census Screened village R_Cen_consent Non_R_Cen_consent R_FU_consent Non_R_FU_consent
collapse  (sum) Census R_Cen_consent Non_R_Cen_consent R_FU_consent Non_R_FU_consent Screened, by(village)
	label define villagel 88888 "Pilot (village)" 99999 "Total", modify
	label values village villagel
