...
tab <- df.temp.consent%>%
  dplyr::select(R_E_r_cen_village_name_str, R_E_jjm_drinking, R_E_jjm_yes, R_E_jjm_stored, R_E_jjm_use__77, R_E_jjm_use_999, R_E_tap_issues, R_E_tap_issues_type__77, R_E_tap_issues_type_1, R_E_water_source_prim, R_E_water_source_kids, R_E_water_prim_source_kids, R_E_water_source_preg, R_E_water_prim_source_preg, R_E_sec_source_reason_999,
                R_E_sec_source_reason__77, R_E_water_sec_yn, R_E_water_sec_freq, R_E_water_treat, R_E_water_treat_kids, R_E_water_treat_type__77, R_E_water_treat_type_999, R_E_water_treat_freq__77, R_E_water_stored)%>%
  rename(Village = R_E_r_cen_village_name_str)
...
#Table1 Output
table1(data = tab, ~ R_E_water_source_prim + R_E_water_source_kids + R_E_water_source_preg)
