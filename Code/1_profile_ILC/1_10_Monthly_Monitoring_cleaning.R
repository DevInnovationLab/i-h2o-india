...
ms$stored_sample_id[ms$unique_id == "40202110019" & ms$stored_sample_id == 20351] <- 20354
ms$stored_sample_id_again[ms$unique_id == "40202110019" & ms$stored_sample_id_again == 20351] <- 20354

ms_view <- ms %>% select(unique_id, stored_sample_id, stored_sample_id_again)
View(ms_view)
#View(ms_view)
correct_replacement <- all(ms$stored_sample_id[ms$unique_id == "40202110019"] == 20354)
