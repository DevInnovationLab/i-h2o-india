...
reshape long new_name_child_ new_age_child_ new_unit_child_age_ new_cause_death_child_ new_cause_death_oth_ new_cause_death_diag_yn_ new_cause_death_child_str_ new_date_birth_child_ new_date_death_child_ , i(unique_id new_woman_name_) j(child_num) string
...
bys unique_id new_woman_name_ : keep if new_name_child_!=""
duplicates report unique_id new_woman_name_ new_name_child_
duplicates tag  unique_id new_woman_name_ new_name_child_, gen(dup_new)
tab dup_new
duplicates drop unique_id new_woman_name_ new_name_child_, force
...
replace village= "Gopi Kankubadi" if village_code=="30701"

//download the renvars package
drop dup dup_new child_num num
...
//reshaping at woman level
reshape long screen_woman_name_ screen_consent_woman_ screen_no_consent_reason_ screen_residence_yesno_ screen_vill_woman_ screen_last_5yrs_preg_ screen_child_living_yn_ screen_child_living_num_ screen_child_away_yn_ screen_child_away_num_ screen_child_still_yn_ screen_child_still_num_ sc_child_died_yn_less24_ sc_child_died_num_less24_ sc_child_died_yn_more24_ sc_child_died_num_more24_ screen_name_child_ screen_age_child_ screen_unit_child_age_ screen_cause_death_child_ screen_cause_death_oth_ screen_cause_death_diag_yn_ screen_miscarriage_yn_, i(unique_id) j(num)

drop if screen_woman_name_==""

drop screen_name_child_ screen_age_child_ screen_unit_child_age_ screen_cause_death_child_ screen_cause_death_diag_yn_ screen_cause_death_oth_ dup
...
//reshaping at child level
reshape long screen_name_child_ screen_age_child_ screen_unit_child_age_ screen_cause_death_child_ screen_cause_death_oth_ screen_cause_death_diag_yn_ screen_date_birth_child_ screen_date_death_child_ , i(unique_id screen_woman_name_) j(child_num) string
...
replace screen_name_child_="New baby2" if screen_woman_name_== "Sasmita Bidika and 18 years" & screen_cause_death_child_=="999"
bys unique_id screen_woman_name_ : keep if screen_name_child_!=""
duplicates report unique_id screen_woman_name_ screen_name_child_
duplicates tag  unique_id screen_woman_name_ screen_name_child_, gen(dup_new)
tab dup_new
duplicates drop unique_id screen_woman_name_ screen_name_child_, force
...
drop child_num num dup dup_new
foreach v in sc_child_died_yn_less24_ sc_child_died_num_less24_ sc_child_died_yn_more24_ sc_child_died_num_more24_ {
...
********************************************************************************
// STEP 4. Appending the two datasets
********************************************************************************

use "${DataRaw}Mortality survey_cleaned vars_newwomen.dta", clear
append using "${DataRaw}Mortality survey_cleaned vars_screenedwomen.dta"

destring cause_death_child_, replace
replace cause_death_child_=77 if cause_death_child_==-77
