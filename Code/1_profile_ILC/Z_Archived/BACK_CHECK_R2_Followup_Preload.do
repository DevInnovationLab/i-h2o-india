...
replace selected = 1 if unique_id == 20101111017
replace selected = 1 if unique_id == 20101111018

replace selected = 1 if unique_id == 20201108022
replace selected = 1 if unique_id == 20201111002



replace selected = 1 if unique_id ==  10101108015 
...
save "${DataPr}selected_`j'_4thApr2024_for_R2_FollowupBC.dta", replace
...
merge 1:1 unique_id using "${DataPr}selected_Asada_4thApr2024_for_R2_FollowupBC.dta", gen(merge_BC_select)
...
export excel unique_id R_FU2_r_cen_village_name_str R_FU2_enum_name R_FU2_enum_name_label R_FU2_r_cen_a10_hhhead R_FU2_Main_Respondent R_FU2_r_cen_a39_phone_name_1 R_FU2_r_cen_a39_phone_num_1 R_FU2_r_cen_a39_phone_name_2 R_FU2_r_cen_a39_phone_num_2 R_FU2_r_cen_landmark R_FU2_r_cen_address R_FU2_r_cen_hamlet_name R_FU2_r_cen_saahi_name R_FU2_r_cen_a11_oldmale_name R_FU2_r_cen_fam_name1 R_FU2_r_cen_fam_name2 R_FU2_r_cen_fam_name3 R_FU2_r_cen_fam_name4 R_FU2_r_cen_fam_name5 R_FU2_r_cen_fam_name6 R_FU2_r_cen_fam_name7 R_FU2_r_cen_fam_name8 R_FU2_r_cen_fam_name9 R_FU2_r_cen_fam_name10 R_FU2_r_cen_fam_name11 R_FU2_r_cen_fam_name12 R_FU2_r_cen_fam_name13 R_FU2_r_cen_fam_name14 R_FU2_r_cen_fam_name15 R_FU2_r_cen_fam_name16 R_FU2_r_cen_fam_name17 R_FU2_r_cen_fam_name18 R_FU2_r_cen_fam_name19 R_FU2_r_cen_fam_name20 R_FU2_water_source_prim using "${DataPre}Backcheck_FU2_preload_4thApr24.xlsx", sheet("Sheet1", replace) firstrow(var) cell(A1)
