...
use "${DataRaw}1_14_Pump_Operator_Survey/pump_operator_survey.dta", clear //importing the raw data with labels generated by SCTO code (need to specify the location)
...
export excel using "${DataPre}1_14_Pump_Operator_Survey/HFC_$S_DATE.xlsx", firstrow(variables) sheet(Surveys_Total, modify) sheetreplace cell(A10)

* Restoring the original dataset	
restore
	
* Formatting exported excel results
putexcel set "${DataPre}1_14_Pump_Operator_Survey/HFC_$S_DATE.xlsx", sheet("Surveys_Total") modify
...
export excel using "${DataPre}1_14_Pump_Operator_Survey/HFC_$S_DATE.xlsx", firstrow(variables) sheet(Surveys_Day_Village-wise, modify) sheetreplace cell(A10)

* Restoring the original dataset 	
restore
		
* Formatting exported excel results
putexcel set "${DataPre}1_14_Pump_Operator_Survey/HFC_$S_DATE.xlsx", sheet("Surveys_Day_Village-wise") modify
...
export excel using "${DataPre}1_14_Pump_Operator_Survey/HFC_$S_DATE.xlsx", firstrow(variables) sheet(Surveys_Day-wise, modify) sheetreplace cell(A10)

* Restoring the original dataset 	
restore
		
* Formatting exported excel results
putexcel set "${DataPre}1_14_Pump_Operator_Survey/HFC_$S_DATE.xlsx", sheet("Surveys_Day-wise") modify
...
export excel using "${DataPre}1_14_Pump_Operator_Survey/HFC_$S_DATE.xlsx", firstrow(variables) sheet(Enumerator_Total, modify) sheetreplace cell(A10)

* Restoring the original dataset	
restore
	
* Formatting exported excel results
putexcel set "${DataPre}1_14_Pump_Operator_Survey/HFC_$S_DATE.xlsx", sheet("Enumerator_Total") modify
...
export excel using "${DataPre}1_14_Pump_Operator_Survey/HFC_$S_DATE.xlsx", firstrow(variables) sheet(Enumerator_Day, modify) sheetreplace cell(A10)
	
* Restoring the original dataset	
restore
	
* Formatting exported excel results
putexcel set "${DataPre}1_14_Pump_Operator_Survey/HFC_$S_DATE.xlsx", sheet("Enumerator_Day") modify
...
export excel using "${DataPre}1_14_Pump_Operator_Survey/HFC_$S_DATE.xlsx", firstrow(variables) sheet(Enum_duration, modify) sheetreplace cell(A10)

* Restoring the original dataset
restore
	
* Formatting exported excel results
putexcel set "${DataPre}1_14_Pump_Operator_Survey/HFC_$S_DATE.xlsx", sheet("Enum_duration") modify 
...
local num_vars `r(varlist)' //storing numeric variables in a macro
	ipacheckmissing  `num_vars', 	///	
		outfile("${DataPre}1_14_Pump_Operator_Survey/HFC_$S_DATE.xlsx") ///	
...
export excel using "${DataPre}1_14_Pump_Operator_Survey/HFC_$S_DATE.xlsx", firstrow(varlabels) sheet("Number_DontKnows", modify) sheetreplace cell(A10)
...
//exporting the results
export excel using "${DataPre}1_14_Pump_Operator_Survey/HFC_$S_DATE.xlsx", firstrow(varlabels) sheet("Number_Others", modify) sheetreplace cell(A10) 
...
sctomedia `var', id(po_unique_id) vars(po_enum_name_label) media("${DataRaw}1_14_Pump_Operator_Survey/media/") output("${external}PO_survey/audio_files/`var'") 
}
