...
------------------------------------------------------------------------------*/
	...
	* Type 'di c(username)' to see the name of your machine
	if c(username)      == "luizaandrade" {
		...
		global overleaf	"//Client/C$/Users/jerem/Dropbox/Apps/Overleaf"
		global DataRaw  "${box}01. 2_Pilot/Data/1_raw/"
		...
		global Intermediate "${pilot}8_Intermediate_Datasets/"
	}
	...
	* Overleaf
	...
	global Table_2 = "${Overleaf}/Descriptive Statistics/Tables/"
